...
`public.coindcx.com/market_data/candlesticks` endpoint for indicator history, while the dashboard price cards are refreshed from CoinDCX futures RT current prices every `POLL_INTERVAL_SECONDS` (default 5s)
